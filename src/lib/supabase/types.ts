    ...
    Tables: {
      ...
      competitor_profiles: {
        Row: {
          ...
          brand_voice_assessment: Json;
          market_sophistication_level: number | null;
          positioning_type: string | null;
          unique_mechanism: string | null;
          strengths: Json;
          weaknesses: Json;
          opportunities_for_us: Json;
          threats_from_them: Json;
          messaging_analysis: Json;
          content_strategy_assessment: Json;
          ad_strategy_assessment: Json;
          funnel_analysis: Json;
          pricing_analysis: Json;
          social_presence_assessment: Json;
          top_performing_themes: Json;
          attack_vectors: Json;
          defensive_moves: Json;
          quick_wins: Json;
          long_term_plays: Json;
